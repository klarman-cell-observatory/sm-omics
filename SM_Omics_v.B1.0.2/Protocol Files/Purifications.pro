		...
		<Startup_Processes >
			<Process >
				...
				<Task Name='BuiltIn::Configure Labware' >
					...
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='//get variables from previous protocol  

getprotocolvariables()

//when running 96 sample batches, some tip boxes will be taken from minihub
//reset tips because used both right and left side of tips in Part 1A for smaller sample numbers
//every tips off operation, including first, has tips_on_loc MINUS columns_samples

if (section == &quot;1A&quot; &amp;&amp; columns_samples &lt; 4){
	tips_on_loc = 13 - columns_samples
	tips_off_loc = 13 - columns_samples
}
else if (section == &quot;1A&quot; &amp;&amp; columns_samples == 6){
//tip box will start first purification with only tips in col 7-12 for 6 col runs
	tips_on_loc = 13
	tips_off_loc = 13
}
else if(section == &quot;2F&quot; &amp;&amp; columns_samples &lt;= 4){
	tips_on_loc = 13 - columns_samples
	tips_off_loc = 13 - columns_samples
}
else if (section == &quot;2H&quot;){
   if (columns_samples == 1 || columns_samples == 2 || columns_samples == 3){
	   tips_on_loc = 13 - columns_samples
	   tips_off_loc = 13 - columns_samples
	}
}

/* this protocol is used for all
four purifications, different static labware
based on what the preceeding protocol was
put them all as static for ease*/' />
					<Parameters >
						...
						<Parameter Category='' Name='9' Value='96 Eppendorf Twin.tec PCR' />
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='/* spri_case 1 is Part 1 Step B cDNA purification
spri_case 2 is Part 1 Step D aRNA purification
spri_case 3 is Part 2 Step G post-ligation purification
spri_case 4 is Part 2 Step I final cDNA purification
elute_vol is amount actually collected
beads are resuspended in elute_vol + 2
dry_time is in seconds // hardcoded to 5 minutes now
vapor_lock indicates if vaporlock is on top of the sample to be purified
if vapor_lock is used, sample will be aspirated from bottom of well with no overaspiration or dynamic tip extension
*/
...
update_status(&quot;Starting purification&quot;)' />
					<Parameters >
		...
		<Main_Processes >
			<Process >
				...
				<Task Name='BuiltIn::Unload' >
					...
					<TaskScript Name='TaskScript' Value='task.unloadFrom = [Nunc_location]' />
					<Parameters >
						<Parameter Category='Task Description' Name='Task number' Value='1' />
...
if(protocol_testing || skip_long_inc) task.Incubationtime = 10;

update_status(&quot;Incubating for 15 minutes&quot;)' />
					<Parameters >
...
update_status(&quot;5 minute incubation on magnet&quot;)' />
					<Parameters >
...
if(protocol_testing) task.Incubationtime = 10;' />
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='Ethanol Wash 3' />
						<Parameter Category='Static labware configuration' Name='Display confirmation' Value='Don&apos;t display' />
						<Parameter Category='Static labware configuration' Name='1' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='2' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='3' Value='&lt;use default&gt;' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='Ethanol Wash 3' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Incubate' >
					<Devices >
...
if(protocol_testing) task.Incubationtime = 10;' />
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='Ethanol Aspiration 3' />
						<Parameter Category='Static labware configuration' Name='Display confirmation' Value='Don&apos;t display' />
						<Parameter Category='Static labware configuration' Name='1' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='2' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='3' Value='&lt;use default&gt;' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='Ethanol Aspiration 3' />
					</Parameters>
				</Task>
...
//task.Incubationtime = dry_time
}

update_status(&quot;Drying beads for 5 minutes&quot;) //+ dry_time/60 + &quot; minutes&quot;)' />
					<Parameters >
...
update_status(&quot;Incubating for 2 minutes&quot;)' />
					<Parameters >
...
update_status(&quot;Incubating on magnet for 2 minutes&quot;)' />
					<Parameters >
				...
				<Task Name='BuiltIn::Load' >
					...
					<TaskScript Name='TaskScript' Value='task.loadIntoByLocation = [Nunc_location]' />
					<Parameters >
			...
			<Process >
				...
				<Task Name='BuiltIn::Load' >
					...
					<TaskScript Name='TaskScript' Value='task.loadIntoByLocation = [Destination_location]' />
					<Parameters >
						<Parameter Category='Task Description' Name='Task number' Value='3' />
						<Parameter Category='Task Description' Name='Task description' Value='Load' />
						<Parameter Category='Task Description' Name='Use default task description' Value='1' />
			...
			<Process >
				...
				<Task Name='BuiltIn::Wait For' Waitfor='WaitForTipsOff' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					<Task_Skipped >0</Task_Skipped>
					<Has_Breakpoint >0</Has_Breakpoint>
			...
			<Process >
				<Minimized >0</Minimized>
				<Task Name='BuiltIn::Wait For' Waitfor='WaitforTipLoad' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					<Task_Skipped >0</Task_Skipped>
					<Has_Breakpoint >0</Has_Breakpoint>
			...
			<Process >
				...
				<Task Name='BuiltIn::Unload' >
					...
					<TaskScript Name='TaskScript' Value='task.unloadFrom = [Collection_location]' />
					<Parameters >
						<Parameter Category='Task Description' Name='Task number' Value='1' />
						<Parameter Category='Task Description' Name='Task description' Value='Unload' />
						<Parameter Category='Task Description' Name='Use default task description' Value='1' />
...
' />
			...
			<Process >
				...
				<Task Name='BuiltIn::Unload' >
					...
					<TaskScript Name='TaskScript' Value='task.unloadFrom = [tipLocation[tipBox-13]]
' />
					<Parameters >
						<Parameter Category='Task Description' Name='Task number' Value='1' />
						<Parameter Category='Task Description' Name='Task description' Value='Unload' />
...
' />
			...
			<Process >
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='//upstack to stacker 2 if there&apos;s room, otherwise use stacker 1
if(tipBox &gt;= 12){
task.skip()
}' />
					<Parameters >
...
update_status(&quot;Adding Sample to beads&quot;)' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='//if running a full plate, need to re-use these tips or else not enough tip space on workstation
//do not want to track them during first usage
if(columns_samples != 12){
trackNew(columns_samples)
}' />
					<Parameters >
						<Parameter Category='Task Description' Name='Task number' Value='4' />
						<Parameter Category='Task Description' Name='Task description' Value='JavaScript' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='if (vapor_lock == 0){
task.Volume = (parseInt(dna_vol) + 8)
//task.Dynamictipextension = 0.036
//task.Distancefromwellbottom = 0.25
}
else{
task.Volume = dna_vol
//task.Dynamictipextension = 0
//task.Distancefromwellbottom = 0.25
}' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='Reaction Plate' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='//dispense over asp above liquid level
if (vapor_lock == 1){
task.skip()
}' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='task.Volume = dna_vol' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='AMPure XP Cleanup 1' />
						<Parameter Category='' Name='Location, location' Value='5' />
						<Parameter Category='Volume' Name='Empty tips' Value='0' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='//at loop end, pipette tip comes up out of plate and gets beads on edges of wells
//had to expand out of loop to prevent this' />
					<Parameters >
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<TaskScript Name='TaskScript' Value='if(dna_bead_vol &lt;= 180){
    task.Volume = (dna_bead_vol - 20)
    print(&quot;Mixing DNA and beads with volume &quot; + task.Volume)
   }else
   {task.Volume = 140
     print (&quot;DNA and beads exceed 180ul or the volume of the tip, mixing with 150ul&quot;)
    }
...
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;6543b50eca2ed8c0ec774d51e47a8e12&apos; version=&apos;1.0&apos; &gt;
	...
	&lt;/WellSelection&gt;
&lt;/Velocity11&gt;' />
						<Parameter Category='Properties' Name='Pipette technique' Value='pipet on north side' />
						<Parameter Category='Task Description' Name='Task number' Value='12' />
						<Parameter Category='Task Description' Name='Task description' Value='Mix (Bravo)' />
						<Parameter Category='Task Description' Name='Use default task description' Value='1' />
					</Parameters>
...
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;6543b50eca2ed8c0ec774d51e47a8e12&apos; version=&apos;1.0&apos; &gt;
	...
	&lt;/WellSelection&gt;
&lt;/Velocity11&gt;' />
						<Parameter Category='Properties' Name='Pipette technique' Value='pipet on right side' />
...
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;6543b50eca2ed8c0ec774d51e47a8e12&apos; version=&apos;1.0&apos; &gt;
	...
	&lt;/WellSelection&gt;
&lt;/Velocity11&gt;' />
						<Parameter Category='Properties' Name='Pipette technique' Value='pipet on south side' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<Parameters >
						...
						<Parameter Category='' Name='Location, location' Value='5' />
						<Parameter Category='Volume' Name='Volume' TaskParameterScript='=elute_vol + 2' Value='30' />
...
//had to expand out of loop to prevent this' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<TaskScript Name='TaskScript' Value='task.Volume = elute_vol*0.8' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='AMPure XP Cleanup 1' />
						<Parameter Category='' Name='Location, location' Value='6' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::Reserve Location' >
					...
					<Parameters >
						...
						<Parameter Category='Task Description' Name='Use default task description' Value='1' />
						<Parameter Category='' Name='Location to use, plate' Value='AMPure XP Cleanup 1' />
...
update_status(&quot;Removing ethanol wash 1&quot;)' />
					<Parameters >
						<Parameter Category='' Name='Head mode' Value='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;9132ba130c10b728fbff387cb5cb659a&apos; version=&apos;1.0&apos; &gt;
	&lt;PipetteHeadMode Channels=&apos;0&apos; ColumnCount=&apos;1&apos; RowCount=&apos;8&apos; SubsetConfig=&apos;3&apos; SubsetType=&apos;1&apos; TipType=&apos;0&apos; /&gt;
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='Ethanol Aspiration 3' >
				<Minimized >0</Minimized>
				<Task Name='Bravo::secondary::Set Head Mode' Task_Type='512' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<Parameters >
						...
						<Parameter Category='Volume' Name='Post-aspirate volume' Value='0' />
						<Parameter Category='Properties' Name='Liquid class' Value='Ethanol to waste' />
						<Parameter Category='Properties' Name='Distance from well bottom' Value='1.35' />
						<Parameter Category='Properties' Name='Dynamic tip extension' Value='0.010' />
						<Parameter Category='Tip Touch' Name='Perform tip touch' Value='0' />
						<Parameter Category='Tip Touch' Name='Which sides to use for tip touch' Value='None' />
						<Parameter Category='Tip Touch' Name='Tip touch retract distance' Value='0' />
...
update_status(&quot;First Ethanol Wash&quot;)' />
					<Parameters >
						<Parameter Category='' Name='Head mode' Value='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;9132ba130c10b728fbff387cb5cb659a&apos; version=&apos;1.0&apos; &gt;
	&lt;PipetteHeadMode Channels=&apos;0&apos; ColumnCount=&apos;1&apos; RowCount=&apos;8&apos; SubsetConfig=&apos;3&apos; SubsetType=&apos;1&apos; TipType=&apos;0&apos; /&gt;
...
update_status(&quot;Second ethanol wash&quot;)' />
					<Parameters >
						<Parameter Category='' Name='Head mode' Value='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;9132ba130c10b728fbff387cb5cb659a&apos; version=&apos;1.0&apos; &gt;
	&lt;PipetteHeadMode Channels=&apos;0&apos; ColumnCount=&apos;1&apos; RowCount=&apos;8&apos; SubsetConfig=&apos;3&apos; SubsetType=&apos;1&apos; TipType=&apos;0&apos; /&gt;
...
//trackUsed(columns_samples)' />
			...
			<Pipette_Process Name='Ethanol Wash 3' >
				<Minimized >0</Minimized>
				<Task Name='Bravo::secondary::Set Head Mode' Task_Type='512' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
...
update_status(&quot;Third ethanol wash&quot;)' />
					<Parameters >
						<Parameter Category='' Name='Head mode' Value='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;9132ba130c10b728fbff387cb5cb659a&apos; version=&apos;1.0&apos; &gt;
	&lt;PipetteHeadMode Channels=&apos;0&apos; ColumnCount=&apos;1&apos; RowCount=&apos;8&apos; SubsetConfig=&apos;3&apos; SubsetType=&apos;1&apos; TipType=&apos;0&apos; /&gt;
...
update_status(&quot;Removing supernatant&quot;)' />
					<Parameters >
						<Parameter Category='' Name='Head mode' Value='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;9132ba130c10b728fbff387cb5cb659a&apos; version=&apos;1.0&apos; &gt;
	&lt;PipetteHeadMode Channels=&apos;0&apos; ColumnCount=&apos;1&apos; RowCount=&apos;8&apos; SubsetConfig=&apos;3&apos; SubsetType=&apos;1&apos; TipType=&apos;0&apos; /&gt;
...
update_status(&quot;Transferring purified sample to new plate&quot;)' />
					<Parameters >
						<Parameter Category='' Name='Head mode' Value='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;9132ba130c10b728fbff387cb5cb659a&apos; version=&apos;1.0&apos; &gt;
	&lt;PipetteHeadMode Channels=&apos;0&apos; ColumnCount=&apos;1&apos; RowCount=&apos;8&apos; SubsetConfig=&apos;3&apos; SubsetType=&apos;1&apos; TipType=&apos;0&apos; /&gt;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='AMPure XP Cleanup 1' />
						<Parameter Category='' Name='Location, location' Value='7' />
						<Parameter Category='Volume' Name='Volume' TaskParameterScript='=elute_vol+1' Value='29' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='print(&quot;Transfering &quot; + task.Volume + &quot;ul to collection plate.&quot;)' />
					<Parameters >
...
' />
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings >
						<Setting Name='Estimated time' Value='378' />
					</Advanced_Settings>
					<TaskScript Name='TaskScript' Value='if(spri_case == 2 || spri_case == 4){
task.Body = &quot;Runset complete. Plate with purified sample is at position 6. Click continue to turn off CPACs and finish protocol.&quot;
}
else{
task.skip()
}' />
				...
				<Task Name='Bravo::Set temperature - Position' >
					...
					<TaskScript Name='TaskScript' Value='//turning off cpacs at end of protocol
if(spri_case == 2 || spri_case == 4){
