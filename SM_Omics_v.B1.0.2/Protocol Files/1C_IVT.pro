...
<Velocity11 file='Protocol_Data' md5sum='bd1bcd9658ad5744902b7d648739f7d4' version='2.0' >
...
//if 1 col, still on tipbox 1 with 2 col gone on left
...
' />
				...
				<Task Name='Bravo::Set temperature - Position' >
					...
					<TaskScript Name='TaskScript' Value='//target 37C on 4, position 6 should still be at 4C
...
task.skip()
					...
					<Parameters >
						...
						<Parameter Category='' Name='Temperature' Value='41' />
...
task.skip()
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='IVT MM Addition' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='IVT MM Addition' />
					</Parameters>
				</Task>
				<Task Name='Bravo::SubProcess' >
					<Enable_Backup >0</Enable_Backup>
...
task.Incubationtime = 10
					...
					<Parameters >
						...
						<Parameter Category='Task Description' Name='Use default task description' Value='1' />
						<Parameter Category='' Name='Incubation time' Value='50400' />
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='Set pos 6 to 4C' />
						<Parameter Category='Static labware configuration' Name='Display confirmation' Value='Don&apos;t display' />
						<Parameter Category='Static labware configuration' Name='1' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='2' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='3' Value='&lt;use default&gt;' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='Set pos 6 to 4C' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Place Plate' >
					<Devices >
...
print(&quot;Spawning tips3 from TipControl&quot;)
}
else{
task.skip()
}' />
   ...
   {task.skip();
			...
			<Process >
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='if(!isEmpty()){
print(&quot;Spawning tips3 from tips2&quot;) 
 }else
   {task.skip();
    }' />
					<Parameters >
...
tipBox++
   ...
   {task.skip();
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='if(isEmpty()){
print(&quot;Spawning emptytips3 from tips2&quot;)
  }else
   {task.skip();
    }' />
					<Parameters >
...
print(&quot;Spawning TipControl from tips2&quot;)
  }else
   {task.skip();
    }' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<Parameters >
						...
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' Value='2.1' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<Parameters >
						...
						<Parameter Category='Volume' Name='Volume' Value='1.4' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::Reserve Location' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='//get pipet tip to come out  of well before aspirating off the vapor lock' />
					<Parameters >
						<Parameter Category='Task Description' Name='Task number' Value='7' />
				...
				<Task Name='BuiltIn::User Message' >
					...
					<TaskScript Name='TaskScript' Value='print(&quot;hi&quot;)' />
					<Parameters >
						<Parameter Category='' Name='Title' Value='Remove plate for vaporlock testing' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<Parameters >
						...
						<Parameter Category='Volume' Name='Post-aspirate volume' Value='0' />
						<Parameter Category='Properties' Name='Liquid class' Value='96 disposable tip 2 - 50ul' />
						<Parameter Category='Properties' Name='Distance from well bottom' Value='5.20' />
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='IVT MM Addition' >
				<Minimized >0</Minimized>
				<Task Name='Bravo::secondary::Set Head Mode' Task_Type='512' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					...
					<TaskScript Name='TaskScript' Value='update_status(&quot;Adding IVT MM to cDNA&quot;)
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<Parameters >
						...
						<Parameter Category='Volume' Name='Volume' Value='27.9' />
						<Parameter Category='Volume' Name='Pre-aspirate volume' Value='3' />
						<Parameter Category='Volume' Name='Post-aspirate volume' Value='0' />
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='Set pos 6 to 4C' >
				<Minimized >0</Minimized>
...
spri_case = 2 // what volumes to use
Destination_location = &quot;Cassette2Slot3&quot; // where to load used sample plate
Collection_location = &quot;Cassette3Slot4&quot; // where to unload new plate for sample collection
