...
<Velocity11 file='Protocol_Data' md5sum='aac8cec640dda0f590f1ed489f3fe84c' version='2.0' >
	<File_Info AllowSimultaneousRun='0' AutoExportGanttChart='0' AutoLoadRacks='When the startup protocol starts' AutoUnloadRacks='0' AutomaticallyLoadFormFile='0' Barcodes_Directory='' ClearInventory='0' DeleteHitpickFiles='1' Description='' Device_File='C:\VWorks Workspace\NGS Option B\SpatialTranscriptomics_v.B1.0.2\Device Files\BravoMiniPHBenchCel2R_round_magnet.dev' Display_User_Task_Descriptions='1' DynamicAssignPlateStorageLoad='0' FinishScript='' Form_File='C:\VWorks Workspace\NGS Option B\SpatialTranscriptomics_v.B1.0.2\Forms\SpatialTranscriptomics_v.B1.0.2.VWForm' HandlePlatesInInstance='1' ImportInventory='0' InventoryFile='' Notes='' PipettePlatesInInstanceOrder='0' Protocol_Alias='' StartScript='open( &apos;C:/VWorks Workspace/NGS Option B/SpatialTranscriptomics_v.B1.0.2/Scripts/tiptracking.js&apos;);
open( &apos;C:/VWorks Workspace/NGS Option B/SpatialTranscriptomics_v.B1.0.2/Scripts/file_operations.js&apos;);
		...
		<Startup_Processes >
			<Process >
				...
				<Task Name='BuiltIn::Configure Labware' >
					...
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='//get protocol variables from temp file
...
' />
				...
				<Task Name='Bravo::Set temperature - Position' >
					...
					<TaskScript Name='TaskScript' Value='//target 50C, position 6 should still be at 4C from previous protocols
if(protocol_testing){task.skip()}' />
					<Parameters >
						...
						<Parameter Category='' Name='Temperature' Value='56' />
		...
		<Main_Processes >
			<Process >
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Process to spawn' Value='emptytips0.5' />
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='if(need_tips != 1){
task.skip()
}
else{
tip_box_to_spawn = &quot;tips0.5&quot;
}' />
					<Parameters >
...
task.skip()
					...
					<Parameters >
						<Parameter Category='' Name='Process to spawn' Value='tips0.5' />
						<Parameter Category='' Name='Spawn as subroutine' Value='' />
						<Parameter Category='' Name='Spawn parameter' Value='' />
					</Parameters>
				</Task>
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='Remove Vaporlock' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='Remove Vaporlock' />
					</Parameters>
				</Task>
				<Task Name='Bravo::SubProcess' >
					<Enable_Backup >0</Enable_Backup>
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='RT MM Addition' />
						<Parameter Category='Static labware configuration' Name='Display confirmation' Value='Don&apos;t display' />
						<Parameter Category='Static labware configuration' Name='1' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='2' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='3' Value='&lt;use default&gt;' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='RT MM Addition' />
					</Parameters>
				</Task>
				<Task Name='Bravo::SubProcess' >
					<Enable_Backup >0</Enable_Backup>
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='Add vaporlock' />
						<Parameter Category='Static labware configuration' Name='Display confirmation' Value='Don&apos;t display' />
						<Parameter Category='Static labware configuration' Name='1' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='2' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='3' Value='&lt;use default&gt;' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='Add vaporlock' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Incubate' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='if(protocol_testing || skip_long_inc){
task.Incubationtime = 10
}
update_status(&quot;1 hour incubation at 50C&quot;)' />
					<Parameters >
						...
						<Parameter Category='Task Description' Name='Use default task description' Value='1' />
						<Parameter Category='' Name='Incubation time' Value='3600' />
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='Dilution before purification' />
						<Parameter Category='Static labware configuration' Name='Display confirmation' Value='Don&apos;t display' />
						<Parameter Category='Static labware configuration' Name='1' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='2' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='3' Value='&lt;use default&gt;' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='Dilution before purification' />
					</Parameters>
				</Task>
				<Plate_Parameters >
			...
			<Process >
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='MasterMix Plate' />
					<Parameter Name='Plate type' Value='96 Eppendorf Twin.tec PCR' />
					<Parameter Name='Simultaneous plates' Value='1' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
			...
			<Process >
				...
				<Task Name='BuiltIn::Unload' >
					...
					<Parameters >
						...
						<Parameter Category='' Name='Barcode Side' Value='West' />
...
' />
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='if(tip_box_to_spawn == &quot;tips0.5&quot;){
print(&quot;Spawning tips0.5 from TipControl&quot;)
}
else{
task.skip()
}' />
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='if(tip_box_to_spawn == &quot;tips1&quot;){
print(&quot;Spawning tips1 from TipControl&quot;)
}
else{
task.skip()
}' />
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='if(tip_box_to_spawn == &quot;tips1.5&quot;){
print(&quot;Spawning tips1.5 from TipControl&quot;)
}
else{
task.skip()
}' />
					<Parameters >
						<Parameter Category='' Name='Process to spawn' Value='tips1.5' />
						<Parameter Category='' Name='Spawn as subroutine' Value='' />
						<Parameter Category='' Name='Spawn parameter' Value='' />
					</Parameters>
				</Task>
...
print(&quot;Spawning tips2 from TipControl&quot;)
}
else{
task.skip()
}' />
				...
				<Plate_Parameters >
					...
					<Parameter Name='Plate type' Value='96 V11 LT180 Tip Box 19477.002 FILTERED' />
					<Parameter Name='Simultaneous plates' Value='1' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
					<Parameter Name='Use single instance of plate' Value='0' />
...
print(&quot;Spawning tips1.5 from tips1&quot;) 
 }else
   {task.skip();
    }' />
					<Parameters >
				...
				<Task Name='BuiltIn::Place Plate' >
					...
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='if(isEmpty()){
print(&quot;Moving empty tip box to position 8 for next subprocess&quot;)
tipBox++
  }else
   {task.skip();
    }' />
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='if(isEmpty()){
print(&quot;Spawning emptytips1.5 from tips1&quot;)
  }else
   {task.skip();
    }' />
					<Parameters >
						<Parameter Category='' Name='Process to spawn' Value='emptytips1.5' />
						<Parameter Category='' Name='Spawn as subroutine' Value='' />
						<Parameter Category='' Name='Spawn parameter' Value='' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Spawn Process' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='if(isEmpty() &amp;&amp; tipBox &lt; 13){
tip_box_to_spawn = &quot;tips1.5&quot;
print(&quot;Spawning TipControl from tips1&quot;)
  }else
   {task.skip();
    }' />
					<Parameters >
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<TaskScript Name='TaskScript' Value='if(isEmpty() &amp;&amp; tipBox &gt;= 13){
tip_box_to_spawn = &quot;tips1.5&quot;
print(&quot;Spawning TipUnload from tips1&quot;)
  }else
   {task.skip();
    }' />
					<Parameters >
						<Parameter Category='' Name='Process to spawn' Value='TipControlUnload' />
						<Parameter Category='' Name='Spawn as subroutine' Value='' />
						<Parameter Category='' Name='Spawn parameter' Value='' />
					</Parameters>
				</Task>
  ...
  print(&quot;Used tip box is not full so keeping at position 8.&quot;);
  }else
   {task.skip();
    }
...
' />
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='if(isFull() &amp;&amp; tipBox &lt; 12){
  print(&quot;Used tip box is full so upstacking to stacker 2&quot;);
	tips_off_loc = 13
	used_col = 0
  }else
   {task.skip();
					...
					<Parameters >
						<Parameter Category='' Name='Process to spawn' Value='Upstack 2' />
						<Parameter Category='' Name='Spawn as subroutine' Value='' />
						<Parameter Category='' Name='Spawn parameter' Value='' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Spawn Process' >
					...
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='if(isFull() &amp;&amp; tipBox &gt;= 12){
  print(&quot;Used tip box is full so upstacking to stacker 1&quot;);
	tips_off_loc = 13
	used_col = 0
  }else
   {task.skip();
					...
					<Parameters >
						<Parameter Category='' Name='Process to spawn' Value='Upstack 1' />
						<Parameter Category='' Name='Spawn as subroutine' Value='' />
						<Parameter Category='' Name='Spawn parameter' Value='' />
					</Parameters>
				</Task>
...
need_tips = 0
   ...
   {task.skip();
				...
				<Task Name='BuiltIn::Place Plate' >
					...
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='if(isEmpty()){
print(&quot;Moving empty tip box to position 8 for next protocol&quot;)
need_tips = 1
tipBox++
  }else
   {task.skip();
...
' />
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='Upstack 2' />
					<Parameter Name='Plate type' Value='96 V11 LT180 Tip Box 19477.002 FILTERED' />
					<Parameter Name='Simultaneous plates' Value='1' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
...
' />
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='Upstack 1' />
					<Parameter Name='Plate type' Value='96 V11 LT180 Tip Box 19477.002 FILTERED' />
					<Parameter Name='Simultaneous plates' Value='1' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
			...
			<Process >
				...
				<Task Name='BuiltIn::Unload' >
					...
					<TaskScript Name='TaskScript' Value='col = 0
tips_on_loc = 0
task.unloadFrom = [tipLocation[tipBox-13]]
' />
					<Parameters >
						<Parameter Category='Task Description' Name='Task number' Value='1' />
						<Parameter Category='Task Description' Name='Task description' Value='Unload' />
...
task.skip()
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='TipControlUnload' />
					<Parameter Name='Plate type' Value='96 V11 LT180 Tip Box 19477.002 FILTERED' />
					<Parameter Name='Simultaneous plates' Value='1' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
			...
			<Process >
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='if(!isEmpty()){
print(&quot;Spawning tips1 from tips0.5&quot;) 
 }else
   {task.skip();
    }' />
					<Parameters >
...
tipBox++
   ...
   {task.skip();
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='if(isEmpty()){
print(&quot;Spawning emptytips1 from tips0.5&quot;)
  }else
   {task.skip();
    }' />
					<Parameters >
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='if(isEmpty() &amp;&amp; tipBox &lt; 13){
tip_box_to_spawn = &quot;tips1&quot;
print(&quot;Spawning TipControl from tips0.5&quot;)}
  else{task.skip();
    }' />
					<Parameters >
						<Parameter Category='' Name='Process to spawn' Value='TipControl' />
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<TaskScript Name='TaskScript' Value='if(isEmpty() &amp;&amp; tipBox &gt;= 13){
tip_box_to_spawn = &quot;tips1&quot;
print(&quot;Spawning TipUnload from tips0.5&quot;)
  }else
   {task.skip();
    }' />
					<Parameters >
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='tips0.5' />
					<Parameter Name='Plate type' Value='96 V11 LT180 Tip Box 19477.002 FILTERED' />
					<Parameter Name='Simultaneous plates' Value='1' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
...
' />
  ...
  print(&quot;Used tip box is full so upstacking to stacker 1&quot;);
   ...
   {task.skip();
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='emptytips0.5' />
					<Parameter Name='Plate type' Value='96 V11 LT180 Tip Box 19477.002 FILTERED' />
					<Parameter Name='Simultaneous plates' Value='1' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
			...
			<Process >
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='if(!isEmpty()){
print(&quot;Spawning tips2 from tips1.5&quot;) 
 }else
   {task.skip();
    }' />
					<Parameters >
...
tipBox++
   ...
   {task.skip();
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='if(isEmpty()){
print(&quot;Spawning emptytips2 from tips1.5&quot;)
  }else
   {task.skip();
    }' />
					<Parameters >
...
print(&quot;Spawning TipControl from tips1.5&quot;)
  }else
   {task.skip();
    }' />
					<Parameters >
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<TaskScript Name='TaskScript' Value='if(isEmpty() &amp;&amp; tipBox &gt;= 13){
tip_box_to_spawn = &quot;tips2&quot;
print(&quot;Spawning TipUnload from tips1.5&quot;)
  }else
   {task.skip();
    }' />
					<Parameters >
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='tips1.5' />
					<Parameter Name='Plate type' Value='96 V11 LT180 Tip Box 19477.002 FILTERED' />
					<Parameter Name='Simultaneous plates' Value='1' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
...
' />
  ...
  print(&quot;Used tip box is full so upstacking to stacker 1&quot;);
   ...
   {task.skip();
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='emptytips1.5' />
					<Parameter Name='Plate type' Value='96 V11 LT180 Tip Box 19477.002 FILTERED' />
					<Parameter Name='Simultaneous plates' Value='1' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
			...
			<Pipette_Process Name='Add vaporlock' >
				<Minimized >0</Minimized>
				<Task Name='Bravo::secondary::Set Head Mode' Task_Type='512' >
					...
					<TaskScript Name='TaskScript' Value='update_status(&quot;Adding VaporLock on top of IVT reaction&quot;)

/* for 12 column runs, use three columns vaporlock
for 6 columns use 2
for less than 6 use single column
*/

if(columns_samples == 12){
	task.Headmode = &quot;1,1,8,3&quot;
	tips = 3
   //first tips on should be from [[1,1]]
   tips_on_loc = -2
   tips_off_loc = -2
}
else if(columns_samples == 6){
	task.Headmode = &quot;1,1,8,2&quot;
	tips = 2
   //first tips on should be from cols 7 &amp; 8
   tips_on_loc = 5
   tips_off_loc = 5
}
else{
	task.Headmode = &quot;1,1,8,1&quot;
	tips = 1
}
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::Loop' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='if(columns_samples == 12){
task.Numberoftimestoloop = 4
}
else if(columns_samples == 6){
task.Numberoftimestoloop = 3
}
else{
task.Numberoftimestoloop = columns_samples
}' />
					<Parameters >
				...
				<Task Name='Bravo::secondary::Tips On' Task_Type='16' >
					...
					<TaskScript Name='TaskScript' Value='tips_on_loc = tips_on_loc + tips
task.Wellselection = [[ 1 , tips_on_loc ]]

print(&quot;Pressing tips on at &quot; + task.Wellselection)' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='tips1.5' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='trackNew(tips)' />
					<Parameters >
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='MasterMix Plate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[1,dispCol]]' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Tips Off' Task_Type='32' >
					...
					<TaskScript Name='TaskScript' Value='tips_off_loc = tips_off_loc + tips
task.Wellselection = [[ 1 , tips_off_loc ]]
print(&quot;Taking tips off at &quot; + task.Wellselection)
' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='emptytips1.5' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Properties' Name='Allow automatic tracking of tip usage' Value='0' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='trackUsed(tips)' />
					<Parameters >
						<Parameter Category='Task Description' Name='Task number' Value='9' />
						<Parameter Category='Task Description' Name='Task description' Value='JavaScript' />
						<Parameter Category='Task Description' Name='Use default task description' Value='1' />
				...
				<Task Name='BuiltIn::Loop End' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='dispCol = dispCol + tips' />
				</Task>
			...
			<Pipette_Process Name='Dilution before purification' >
				<Minimized >0</Minimized>
				<Task Name='Bravo::secondary::Set Head Mode' Task_Type='512' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					...
					<TaskScript Name='TaskScript' Value='update_status(&quot;Diluting sample&quot;)

task.Headmode = head_mode
' />
					<Parameters >
						<Parameter Category='' Name='Head mode' Value='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Tips On' Task_Type='16' >
					...
					<TaskScript Name='TaskScript' Value='tips_on_loc = 13 - columns_samples
task.Wellselection = [[ 1 , tips_on_loc ]]
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='//dispense above vaporlock
' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='Reaction Plate' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::Reserve Location' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='//bring pipette tip out of well' />
					<Parameters >
						<Parameter Category='Task Description' Name='Task number' Value='7' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<Parameters >
						...
						<Parameter Category='Properties' Name='Dynamic tip extension' Value='0' />
						<Parameter Category='Distance From Well Bottom' Name='Aspirate distance' Value='37' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='//aspirate off the vaporlock' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='Reaction Plate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
...
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;e361f4abaf03a381270fef6afe792f5c&apos; version=&apos;1.0&apos; &gt;
	...
	&lt;/WellSelection&gt;
&lt;/Velocity11&gt;' />
						<Parameter Category='Properties' Name='Pipette technique' Value='pipet on left side' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Tips Off' Task_Type='32' >
					...
					<TaskScript Name='TaskScript' Value='tips_off_loc = 13 -columns_samples
task.Wellselection = [[ 1 , tips_off_loc ]]
print(&quot;Taking tips off at &quot; + task.Wellselection)
' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='RT MM Addition' >
				<Minimized >0</Minimized>
				<Task Name='Bravo::secondary::Set Head Mode' Task_Type='512' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					...
					<TaskScript Name='TaskScript' Value='update_status(&quot;Adding RT Master Mix&quot;)
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::Loop' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Number of times to loop' TaskParameterScript='=columns_samples' Value='1' />
						<Parameter Category='' Name='Change tips every N times, N = ' Value='1' />
					</Parameters>
					<Variables >
						<Variable fIncrement='1' iFreqValue='0' strFrequency='Every time' strInitialValue='1' strVariableName='dispCol' />
					</Variables>
				</Task>
				<Task Name='Bravo::secondary::Tips On' Task_Type='16' >
					<Enable_Backup >0</Enable_Backup>
					...
					<TaskScript Name='TaskScript' Value='tips_on_loc = tips_on_loc + 1
task.Wellselection = [[ 1 , tips_on_loc ]]
...
task.Wellselection = [[1,dispCol]]' />
					<Parameters >
						...
						<Parameter Category='Properties' Name='Liquid class' Value='RnaseH DNA pol I mix' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Tips Off' Task_Type='32' >
					...
					<TaskScript Name='TaskScript' Value='tips_off_loc = tips_off_loc + 1
task.Wellselection = [[ 1 , tips_off_loc ]]
print(&quot;Taking tips off at &quot; + task.Wellselection)
' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Set temperature - Position' Task_Type='1024' >
					...
					<TaskScript Name='TaskScript' Value='//target 50C
if(protocol_testing){task.skip()}' />
					<Parameters >
						<Parameter Category='' Name='Location' Value='4' />
						<Parameter Category='' Name='Turn off temperature' Value='0' />
						...
						<Parameter Category='' Name='Temperature Tolerance' Value='0' />
						<Parameter Category='' Name='Timeout' Value='60' />
						<Parameter Category='' Name='Allow concurrent operation' Value='0' />
						<Parameter Category='Task Description' Name='Task number' Value='13' />
						<Parameter Category='Task Description' Name='Task description' Value='Set temperature - Position (Bravo)' />
						<Parameter Category='Task Description' Name='Use default task description' Value='1' />
				...
				<Task Name='BuiltIn::Group End' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='stack = &quot;dilution&quot;' />
					<Parameters >
						<Parameter Category='Task Description' Name='Task number' Value='14' />
						<Parameter Category='Task Description' Name='Task description' Value='Group End' />
						<Parameter Category='Task Description' Name='Use default task description' Value='1' />
			...
			<Pipette_Process Name='Remove Vaporlock' >
				<Minimized >0</Minimized>
				<Task Name='Bravo::secondary::Set Head Mode' Task_Type='512' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					...
					<TaskScript Name='TaskScript' Value='update_status(&quot;Removing vaporlock&quot;)

task.Headmode = head_mode

//if 1,2, or 3 column runs, some tips already removed from right side of tip box
if (columns_samples == 1){
  tips_on_loc = 4
  tips_off_loc = 4
}
...
else if (columns_samples == 3){
   tips_on_loc = 7
   tips_off_loc = 7
}
else{
   tips_on_loc = 13 - columns_samples
   tips_off_loc = 13 - columns_samples
}' />
					<Parameters >
						<Parameter Category='' Name='Head mode' Value='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;e6581fadfee31ff9bb07b07e83081e45&apos; version=&apos;1.0&apos; &gt;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Tips On' Task_Type='16' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[ 1 , tips_on_loc ]]

print(&quot;Pressing tips on at &quot; + task.Wellselection)' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='tips0.5' />
						<Parameter Category='' Name='Location, location' Value='2' />
						<Parameter Category='Properties' Name='Allow automatic tracking of tip usage' Value='0' />
						<Parameter Category='Properties' Name='Well selection' Value='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;22661f8e3cb8dba834c3454d52c3ef02&apos; version=&apos;1.0&apos; &gt;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<Parameters >
						...
						<Parameter Category='Volume' Name='Post-aspirate volume' Value='0' />
						<Parameter Category='Properties' Name='Liquid class' Value='96 disposable tip 2 - 50ul' />
						<Parameter Category='Properties' Name='Distance from well bottom' Value='2.6' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings >
						<Setting Name='Estimated time' Value='419' />
					</Advanced_Settings>
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='1' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Tips Off' Task_Type='32' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[ 1 , tips_off_loc ]]
print(&quot;Taking tips off at &quot; + task.Wellselection)
' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='emptytips0.5' />
						<Parameter Category='' Name='Location, location' Value='8' />
						<Parameter Category='Properties' Name='Allow automatic tracking of tip usage' Value='0' />
						<Parameter Category='Properties' Name='Mark tips as used' Value='1' />
						<Parameter Category='Properties' Name='Well selection' Value='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
		...
		<Cleanup_Processes >
			<Process >
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='//overwrite ST_temp.txt with new variables 
//for use in the next protocol
//need_tips
//col
//used_col
//Nunc plate to use, etc.


Nunc_location = &quot;Cassette2Slot5&quot; //where to take cleanup plate from
spri_case = 4 // what volumes to use
Destination_location = &quot;Cassette1Slot3&quot; // where to load used sample plate
Collection_location = &quot;Cassette2Slot4&quot; // where to unload new plate for sample collection

var update_temp_file = (need_tips + &quot;\n&quot; + col + &quot;\n&quot; + used_col + &quot;\n&quot; + Nunc_location + &quot;\n&quot; + head_mode + &quot;\n&quot; + columns_samples + &quot;\n&quot; + tips_on_loc + &quot;\n&quot; + tips_off_loc + &quot;\n&quot; + spri_case + &quot;\n&quot; + protocol_testing + &quot;\n&quot; + tipBox + &quot;\n&quot; + Collection_location + &quot;\n&quot; + Destination_location)
file_overwrite(&quot;C:\\VWorks Workspace\\NGS Option B\\SpatialTranscriptomics_v.B1.0.2\\Scripts\\ST_temp.txt&quot; , update_temp_file)
' />
					<Parameters >
						<Parameter Category='Task Description' Name='Task number' Value='1' />
						<Parameter Category='Task Description' Name='Task description' Value='JavaScript' />
