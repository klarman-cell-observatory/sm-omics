...
' Use_Global_JS_Context='1' />
   ...
   task.skip()
					...
					<Parameters >
						...
						<Parameter Category='' Name='Body' Value='WARNING: A checkbox under TESTING ONLY has been selected. This will reduce incubation times, mix cycles, and temperature settings. If this is desired, click Continue, otherwise, click pause, uncheck the box, and then click Continue.' />
				...
				<Task Name='Bravo::Set temperature - Position' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings >
						<Setting Name='Estimated time' Value='479' />
					</Advanced_Settings>
					<TaskScript Name='TaskScript' Value='if(protocol_testing){task.skip()}' />
					<Parameters >
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Parameters >
						<Parameter Category='' Name='Title' Value='' />
						<Parameter Category='' Name='Body' Value='CPACs have reached temperature
Please place plates on Bravo deck' />
						<Parameter Category='' Name='Only show the first time' Value='' />
						<Parameter Category='' Name='Display dialog box' Value='1' />
						<Parameter Category='' Name='Pause process' Value='1' />
						<Parameter Category='' Name='Email' Value='0' />
				...
				<Task Name='BuiltIn::Configure Labware' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='//sets head_mode var based on column number
//only used in spri steps
		...
		<Main_Processes >
			<Process >
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='Ligation MM Addition' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='Ligation MM Addition' />
					</Parameters>
				</Task>
...
update_status(&quot;1 hour incubation at 25C&quot;)' />
					<Parameters >
						<Parameter Category='Task Description' Name='Task number' Value='5' />
						<Parameter Category='Task Description' Name='Task description' Value='Incubate' />
						<Parameter Category='Task Description' Name='Use default task description' Value='1' />
						<Parameter Category='' Name='Incubation time' Value='10800' />
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='Ramp Down' />
						<Parameter Category='Static labware configuration' Name='Display confirmation' Value='Don&apos;t display' />
						<Parameter Category='Static labware configuration' Name='1' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='2' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='3' Value='&lt;use default&gt;' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='Ramp Down' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Spawn Process' >
					<Enable_Backup >0</Enable_Backup>
   ...
   {task.skip();
			...
			<Process >
				...
				<Task Name='BuiltIn::Upstack' >
					...
					<TaskScript Name='TaskScript' Value='	tips_off_loc = 13
	used_col = 0
' />
					<Parameters >
						<Parameter Category='Task Description' Name='Task number' Value='2' />
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='Ligation MM Addition' >
				<Minimized >0</Minimized>
				<Task Name='Bravo::secondary::Set Head Mode' Task_Type='512' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					...
					<TaskScript Name='TaskScript' Value='update_status(&quot;Adding Ligation Master Mix&quot;)
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Set temperature - Position' Task_Type='1024' >
					...
					<TaskScript Name='TaskScript' Value='//target 25C
if(protocol_testing){task.skip()}' />
					<Parameters >
						<Parameter Category='' Name='Location' Value='6' />
						<Parameter Category='' Name='Turn off temperature' Value='0' />
						<Parameter Category='' Name='Temperature' Value='26' />
						<Parameter Category='' Name='Wait' Value='1' />
			...
			<Pipette_Process Name='Ramp Down' >
				<Minimized >0</Minimized>
...
Nunc_location = &quot;Cassette1Slot5&quot; //where to take cleanup plate from
spri_case = 3 // what volumes to use
Destination_location = &quot;Cassette1Slot4&quot; // where to load used sample plate
Collection_location = &quot;Cassette1Slot3&quot; // where to unload new plate for sample collection
