...
<Velocity11 file='Protocol_Data' md5sum='4e6f9f5ca7ca80e614107742c4486e5d' version='2.0' >
...
task.skip()
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='EDTA Addition' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='EDTA Addition' />
					</Parameters>
				</Task>
				<Plate_Parameters >
...
' />
			...
			<Pipette_Process Name='EDTA Addition' >
				<Minimized >0</Minimized>
				<Task Name='Bravo::secondary::Set Head Mode' Task_Type='512' >
					...
					<TaskScript Name='TaskScript' Value='update_status(&quot;Adding EDTA to cDNA&quot;)

/* for 12 column runs, use two columns of EDTA for speed
and to fit all reagents in a PCR plate

for less than 12 columns, use single column
*/

if(columns_samples == 12){
	task.Headmode = &quot;1,1,8,2&quot;
	tips = 2
   //first tips on should be at [[1,1]]
   tips_on_loc = -1
   tips_off_loc = -1
}
else{
...
spri_case = 1 // what volumes to use
Destination_location = &quot;Cassette2Slot4&quot; // where to load used sample plate
Collection_location = &quot;Cassette2Slot3&quot; // where to unload new plate for sample collection
...
' />
				...
				<Task Name='Bravo::Set temperature - Position' >
					...
					<TaskScript Name='TaskScript' Value='//keep position 4 and 6 cold
