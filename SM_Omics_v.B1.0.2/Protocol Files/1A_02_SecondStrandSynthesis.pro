...
<Velocity11 file='Protocol_Data' md5sum='52b22273b552577ee386b7b46991940a' version='2.0' >
			...
			<Process >
				...
				<Task Name='Bravo::Set temperature - Position' >
					...
					<Parameters >
						...
						<Parameter Category='' Name='Temperature' Value='15' />
...
//switching from using right side of tip box to left side of tip box
tips_on_loc = 0
tips_off_loc = 0' />
					<Parameters >
...
task.skip()
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='T4 DNA Pol Addition' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='T4 DNA Pol Addition' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Place Plate' >
					<Devices >
				...
				<Task Name='BuiltIn::Signal' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Waitfors_To_Signal >
						<Waitfor Name='WaitforIncubationStart' />
					</Waitfors_To_Signal>
				</Task>
...
update_status(&quot;20 min incubation at 16C&quot;)' />
					<Parameters >
				...
				<Task Name='BuiltIn::Signal' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Waitfors_To_Signal >
						<Waitfor Name='WaitforIncubationFinish' />
					</Waitfors_To_Signal>
				</Task>
				...
				<Task Name='BuiltIn::Signal' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Waitfors_To_Signal >
						<Waitfor Name='Wait For Sample Plate Move' />
					</Waitfors_To_Signal>
				</Task>
				<Plate_Parameters >
			...
			<Process >
				...
				<Task Name='BuiltIn::Wait For' Waitfor='WaitforIncubationStart' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					<Task_Skipped >0</Task_Skipped>
					<Has_Breakpoint >0</Has_Breakpoint>
				...
				<Task Name='BuiltIn::Wait For' Waitfor='WaitforIncubationFinish' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					<Task_Skipped >0</Task_Skipped>
					<Has_Breakpoint >0</Has_Breakpoint>
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='Cool Pos 4' />
						<Parameter Category='Static labware configuration' Name='Display confirmation' Value='Don&apos;t display' />
						<Parameter Category='Static labware configuration' Name='1' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='2' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='3' Value='&lt;use default&gt;' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='Cool Pos 4' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Wait For' Waitfor='Wait For Sample Plate Move' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					<Task_Skipped >0</Task_Skipped>
					<Has_Breakpoint >0</Has_Breakpoint>
...
' />
			...
			<Pipette_Process Name='Cool Pos 4' >
				<Minimized >0</Minimized>
			...
			<Pipette_Process Name='T4 DNA Pol Addition' >
				<Minimized >0</Minimized>
				<Task Name='Bravo::secondary::Set Head Mode' Task_Type='512' >
					...
					<TaskScript Name='TaskScript' Value='update_status(&quot;Adding DNA pol for second strand synthesis&quot;)
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<Parameters >
						...
						<Parameter Category='Properties' Name='Liquid class' Value='96 disposable tip 5ul Mastermix' />
