...
<Velocity11 file='Protocol_Data' md5sum='1913ee7ccd811bf8eda06194e898765f' version='2.0' >
	...
	<Processes >
		...
		<Main_Processes >
			<Process >
				<Minimized >0</Minimized>
				<Task Name='BuiltIn::Wait For' Waitfor='Wait For Tips on Deck' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					<Task_Skipped >0</Task_Skipped>
					<Has_Breakpoint >0</Has_Breakpoint>
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='Permeabilization addition and removal' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='Permeabilization addition and removal' />
					</Parameters>
				</Task>
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='pre-perm/perm reagent' />
			...
			<Process >
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='WB3 Wash' />
						<Parameter Category='Static labware configuration' Name='Display confirmation' Value='Don&apos;t display' />
						<Parameter Category='Static labware configuration' Name='1' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='2' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='3' Value='&lt;use default&gt;' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='WB3 Wash' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Load' >
					<Devices >
			...
			<Process >
				...
				<Task Name='BuiltIn::Signal' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Waitfors_To_Signal >
						<Waitfor Name='Wait For Tips on Deck' />
					</Waitfors_To_Signal>
				</Task>
				<Task Name='Bravo::SubProcess' >
					<Enable_Backup >0</Enable_Backup>
			...
			<Pipette_Process Name='Permeabilization addition and removal' >
				<Minimized >0</Minimized>
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='pre-perm/perm reagent' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::Reserve Location' >
					...
					<Parameters >
						...
						<Parameter Category='' Name='Reservation time' Value='600' />
					</Parameters>
				</Task>
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='Transfer tips' >
				...
				<Task Name='Bravo::secondary::Set temperature - Position' Task_Type='1024' >
					...
					<TaskScript Name='TaskScript' Value='//target 42C
...
if(protocol_testing || skip_long_inc){task.skip()}' />
					<Parameters >
						...
						<Parameter Category='' Name='Temperature' Value='43' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::Reserve Location' >
					...
					<Parameters >
						...
						<Parameter Category='' Name='Location to use, plate' Value='6' />
						<Parameter Category='' Name='Location to use, location' Value='6' />
						<Parameter Category='' Name='Reservation time' Value='10' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Loop' >
					<Enable_Backup >0</Enable_Backup>
