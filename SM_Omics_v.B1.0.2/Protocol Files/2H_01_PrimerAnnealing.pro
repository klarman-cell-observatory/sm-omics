...
<Velocity11 file='Protocol_Data' md5sum='ca04631b4d748a60d753de4d62f97304' version='2.0' >
...
//iff 1 col, still on tipBox 1 with col 1 removed
if(columns_samples == 1){
   tips_on_loc  = 1
   tips_off_loc = 1
}
//reset after taking from right side of box during purifications
else if(need_tips != 1){
	tips_on_loc = 0
	tips_off_loc = 0
}
...
//used for special tip tracking in purification protocol 
section = &quot;2H&quot;' />
					<Parameters >
				...
				<Task Name='Bravo::Set temperature - Position' >
					...
					<TaskScript Name='TaskScript' Value='//target 65C on 4, position 6 should still be at 4C
...
task.skip()
					...
					<Parameters >
						...
						<Parameter Category='' Name='Temperature' Value='75' />
		...
		<Main_Processes >
			<Process >
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Process to spawn' Value='MasterMix Plate' />
...
task.skip()
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='RT Primer and dNTP Addition' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='RT Primer and dNTP Addition' />
					</Parameters>
				</Task>
				<Task Name='Bravo::SubProcess' >
					<Enable_Backup >0</Enable_Backup>
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='VaporLock Addition' />
						<Parameter Category='Static labware configuration' Name='Display confirmation' Value='Don&apos;t display' />
						<Parameter Category='Static labware configuration' Name='1' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='2' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='3' Value='&lt;use default&gt;' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='VaporLock Addition' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Place Plate' >
					<Devices >
				...
				<Task Name='BuiltIn::Signal' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Waitfors_To_Signal >
						<Waitfor Name='WaitforSampleMove' />
					</Waitfors_To_Signal>
				</Task>
...
task.Incubationtime = 10
				...
				<Task Name='BuiltIn::Signal' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Waitfors_To_Signal >
						<Waitfor Name='WaitforIncubationEnd' />
					</Waitfors_To_Signal>
				</Task>
				<Task Name='BuiltIn::Wait For' Waitfor='WaitforMMPlateMove' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					<Task_Skipped >0</Task_Skipped>
					<Has_Breakpoint >0</Has_Breakpoint>
			...
			<Process >
				...
				<Task Name='BuiltIn::Wait For' Waitfor='WaitforSampleMove' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					<Task_Skipped >0</Task_Skipped>
					<Has_Breakpoint >0</Has_Breakpoint>
				...
				<Task Name='BuiltIn::Wait For' Waitfor='WaitforIncubationEnd' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					<Task_Skipped >0</Task_Skipped>
					<Has_Breakpoint >0</Has_Breakpoint>
				...
				<Task Name='BuiltIn::Signal' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Waitfors_To_Signal >
						<Waitfor Name='WaitforMMPlateMove' />
					</Waitfors_To_Signal>
				</Task>
				<Plate_Parameters >
...
print(&quot;Spawning tips2 from tips1&quot;) 
 }else
   {task.skip();
    }' />
					<Parameters >
...
tipBox++
   ...
   {task.skip();
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='if(isEmpty()){
print(&quot;Spawning emptytips2 from tips1&quot;)
  }else
   {task.skip();
    }' />
					<Parameters >
...
' />
  ...
  print(&quot;Used tip box is full so upstacking to stacker 2&quot;);
   ...
   {task.skip();
					...
					<Parameters >
						<Parameter Category='' Name='Process to spawn' Value='Upstack' />
						<Parameter Category='' Name='Spawn as subroutine' Value='' />
						<Parameter Category='' Name='Spawn parameter' Value='' />
					</Parameters>
				</Task>
...
' />
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='Upstack' />
					<Parameter Name='Plate type' Value='96 V11 LT180 Tip Box 19477.002 FILTERED' />
					<Parameter Name='Simultaneous plates' Value='1' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
			...
			<Pipette_Process Name='RT Primer and dNTP Addition' >
				<Minimized >0</Minimized>
				<Task Name='Bravo::secondary::Set Head Mode' Task_Type='512' >
					...
					<TaskScript Name='TaskScript' Value='update_status(&quot;Adding primer/dNTP mix to adapter ligated RNA&quot;)
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<Parameters >
						...
						<Parameter Category='Properties' Name='Liquid class' Value='dNTP RT Primer Mix' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<Parameters >
						...
						<Parameter Category='Properties' Name='Liquid class' Value='fast dispense then long wait' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Tips Off' Task_Type='32' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings >
						<Setting Name='Estimated time' Value='985' />
					</Advanced_Settings>
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::Loop End' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='dispCol = dispCol + 1' />
				</Task>
			...
			<Pipette_Process Name='VaporLock Addition' >
				<Minimized >0</Minimized>
				<Task Name='Bravo::secondary::Set Head Mode' Task_Type='512' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Set temperature - Position' Task_Type='1024' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings >
						<Setting Name='Estimated time' Value='349' />
					</Advanced_Settings>
					<TaskScript Name='TaskScript' Value='//target 65C on 4
...
task.skip()
			...
			<Time_Constraints >
				<Constraint ConstrainedIsInSubProcess='0' ConstrainedProcess='Reaction Plate' ConstrainedTaskIndex='7' ConstrainingIsInSubProcess='1' ConstrainingProcess='VaporLock Addition' ConstrainingTaskIndex='10' MaxDelta='930' MinDelta='600' TimeDelta='900' Unit='s' />
			</Time_Constraints>
		</Main_Processes>
		<Cleanup_Processes >
			<Process >
