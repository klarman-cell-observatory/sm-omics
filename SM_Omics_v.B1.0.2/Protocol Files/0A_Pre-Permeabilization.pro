...
<Velocity11 file='Protocol_Data' md5sum='10e94c679bf4a93f13f2dddffbcf096e' version='2.0' >
		...
		<Startup_Processes >
			<Process >
				...
				<Task Name='BuiltIn::User Message' >
					...
					<TaskScript Name='TaskScript' Value='if(protocol_testing == 0 || skip_lonc_inc == 0){
   task.skip()
}' />
					<Parameters >
						<Parameter Category='' Name='Title' Value='' />
						<Parameter Category='' Name='Body' Value='The testing only box is checked. If this is not intended, abort protocol and restart with box unchecked' />
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Parameters >
						<Parameter Category='' Name='Title' Value='' />
						<Parameter Category='' Name='Body' Value='Ensure all tip  boxes in stacker 1 have tips on left hand side, missing column should be on right hand side' />
						<Parameter Category='' Name='Only show the first time' Value='' />
						<Parameter Category='' Name='Display dialog box' Value='1' />
						<Parameter Category='' Name='Pause process' Value='1' />
						<Parameter Category='' Name='Email' Value='0' />
				...
				<Task Name='Bravo::Set temperature - Position' >
					...
					<TaskScript Name='TaskScript' Value='//target 37C
...
if(protocol_testing || skip_long_inc){task.skip()}' />
					<Parameters >
						...
						<Parameter Category='' Name='Timeout' Value='30' />
						<Parameter Category='' Name='Allow concurrent operation' Value='0' />
				...
				<Task Name='Bravo::Set temperature - Position' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings >
						<Setting Name='Estimated time' Value='512' />
					</Advanced_Settings>
					<TaskScript Name='TaskScript' Value='if(protocol_testing || skip_long_inc){task.skip()}' />
					<Parameters >
						<Parameter Category='' Name='Location' Value='4' />
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings >
						<Setting Name='Estimated time' Value='3037' />
					</Advanced_Settings>
					<TaskScript Name='TaskScript' Value='if(protocol_testing || skip_long_inc){task.skip()}' />
					<Parameters >
						<Parameter Category='' Name='Title' Value='' />
						<Parameter Category='' Name='Body' Value='Position 4 has cooled to 4C. Place cDNA synth/probe release plate at position 4.' />
						<Parameter Category='' Name='Only show the first time' Value='' />
						<Parameter Category='' Name='Display dialog box' Value='1' />
						<Parameter Category='' Name='Pause process' Value='1' />
						<Parameter Category='' Name='Email' Value='0' />
		...
		<Main_Processes >
			<Process >
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='Pre-permeabilization addition and removal' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='Pre-permeabilization addition and removal' />
					</Parameters>
				</Task>
			...
			<Process >
				...
				<Task Name='BuiltIn::Signal' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Waitfors_To_Signal >
						<Waitfor Name='Wait For WB3 Load' />
					</Waitfors_To_Signal>
				</Task>
				<Plate_Parameters >
			...
			<Process >
				...
				<Task Name='BuiltIn::Wait For' Waitfor='Wait For WB3 Load' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					<Task_Skipped >0</Task_Skipped>
					<Has_Breakpoint >0</Has_Breakpoint>
				...
				<Task Name='BuiltIn::Place Plate' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='//top two rows remaining, spare tip box' />
					<Parameters >
						<Parameter Category='Task Description' Name='Task number' Value='5' />
						<Parameter Category='Task Description' Name='Task description' Value='Place Plate' />
						<Parameter Category='Task Description' Name='Use default task description' Value='1' />
			...
			<Pipette_Process Name='Pre-permeabilization addition and removal' >
				<Minimized >0</Minimized>
