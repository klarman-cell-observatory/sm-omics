...
#bravo_cy3_files = list.files("./if_diffusion", pattern = "bravo_cy3") #for sm-omics IF diffution estimates
bravo_cy3_files = list.files("./he_diffusion", pattern = "manual_cy3") #for regular st HE diffusion estimates
